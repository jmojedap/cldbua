        ...
        <div class="card">
            <div class="card-body">
                <div class="row" v-for="(element, ke) in list">
                    <div class="col-md-9">
                        <div class="media">
                            <a v-bind:href="`<?= URL_FRONT . "cursos/abrir_elemento/" ?>` + element.id + `/` + element.current_element_index">
                    ...
                    <div class="col-md-3">
                        <a class="btn btn-main btn-block"
                            v-bind:href="`<?= URL_FRONT . "cursos/abrir_elemento/" ?>` + element.id + `/` + element.current_element_index"
