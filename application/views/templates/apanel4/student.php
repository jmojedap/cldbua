...
<html>
    <head>
        <?php $this->load->view('templates/apanel4/student/head'); ?>
    </head>
    <body>
        <div class="layout">
            <div class="main-nav">
                <?php $this->load->view("templates/apanel4/student/aside"); ?>
            </div>
            <div class="main-content">
                <div class="container-fluid">
                    <div class="d-flex">
                        ...
                        <?php $this->load->view('templates/apanel4/student/head_tools') ?>
                    </div>
