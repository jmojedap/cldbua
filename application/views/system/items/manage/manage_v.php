    ...
    <div class="row">
        <div class="col-md-3">
            <table class="table bg-white">
                <tbody>
                    <tr v-for="(category, category_key) in categories" v-bind:class="{'table-info': category_key == category_id}">
        ...
        <div class="col-md-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php $this->load->view('system/items/manage/form_v'); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php $this->load->view('system/items/manage/vue_v'); ?>